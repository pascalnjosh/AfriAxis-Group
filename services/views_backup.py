...
def send_wifi_stk_push(phone_number, amount, account_reference, transaction_desc):
    ...
    if not response.ok:
        try:
            ...
            body = ""
        raise requests.HTTPError(body, response=response)
